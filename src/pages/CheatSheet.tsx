...
const thresholds: { rule: string; threshold: string }[] = [
  ...
  { rule: 'Civil SOL — 1956 act, registration/licensing claim', threshold: '2 yrs from contract of sale' },
  { rule: 'Civil SOL — 1956 act, fraud claim', threshold: '2 yrs from discovery, max 4 yrs from contract of sale' },
  { rule: 'Civil SOL — 2002 act', threshold: 'Earlier of 2 yrs discovery / 5 yrs violation' },
