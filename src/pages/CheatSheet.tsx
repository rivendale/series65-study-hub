...
const thresholds: { rule: string; threshold: string }[] = [
  ...
  { rule: 'Civil SOL — 1956 act (§410(f))', threshold: 'Earlier of 3 yrs from sale OR rendering of advice, or 2 yrs from discovery' },
  { rule: 'Civil SOL — 2002 act, fraud (§509(j)(2))', threshold: 'Earlier of 2 yrs discovery / 5 yrs violation' },
  { rule: 'Civil SOL — 2002 act, registration violation (§509(j)(1))', threshold: '1 yr after the violation, no discovery prong' },
