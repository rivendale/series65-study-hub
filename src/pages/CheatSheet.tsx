...
const thresholds: { rule: string; threshold: string }[] = [
  ...
  { rule: 'Statute of limitations (civil) — 1956 act', threshold: '2 yrs from contract of sale' },
  { rule: 'Statute of limitations (civil) — 2002 act', threshold: 'Earlier of 2 yrs discovery / 5 yrs violation' },
