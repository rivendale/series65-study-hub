...
- **Access is restricted.** Funds relying on the **3(c)(1)** exclusion limit beneficial owners (generally **no more than 100**) and sell to **accredited investors**; **3(c)(7)** funds sell only to **qualified purchasers** — broadly, individuals with at least **$5 million in investments** — and may have many more holders. Accredited investor status for an individual generally means **$1 million net worth excluding the primary residence**, or income of **$200,000 (or $300,000 with a spouse) in each of the two most recent years**.

  Since the SEC's **2020 amendments to Rule 501(a)**, wealth is no longer the only route in. An individual also qualifies by **professional credential** — currently the **Series 7, Series 65, or Series 82** held in good standing — or as a **knowledgeable employee** of the private fund doing the offering. Worth noticing if you are studying for the Series 65: **passing this exam and registering as an IAR is itself a qualifying credential**, whatever your net worth. The principle behind the amendment is the tested point — accreditation is a proxy for the **ability to evaluate and bear the risk** of an unregistered offering, and demonstrated expertise serves that purpose as well as a balance sheet does. The **dollar tests themselves were not changed** in 2020; only the ways of qualifying were widened.
...
Two obligations run past the sale. **Eligibility is checked at purchase, not maintained afterward**: a client who ceases to be accredited does not automatically get out. And a fiduciary's duty to monitor does not lapse because the position is illiquid — an adviser who cannot obtain a defensible valuation still has to tell the client that.`,
  pitfalls: [
    ...
    "Accredited investor status is not purely financial. Since the 2020 amendments to Rule 501(a) a Series 7, Series 65, or Series 82 holder in good standing qualifies on credential alone, as does a knowledgeable employee of the fund. Answering that only net worth or income can qualify an individual is now wrong.",
  ],
  keyTerms: [
    {
      term: 'REIT',
