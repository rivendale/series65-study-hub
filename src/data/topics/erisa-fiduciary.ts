...
**Eligibility.** A plan may require **age 21** and **one year of service** (generally 1,000 hours), and no more. Entry must then occur no later than the **earlier** of the first day of the next plan year or **six months** later, which is why most plans use **semiannual entry dates** of January 1 and July 1. A plan vesting employer money immediately may use a **two-year** service condition, but not for elective deferrals, and **long-term part-time** employees must be allowed to defer after **two consecutive years of at least 500 hours** — SECURE 2.0 cut this from SECURE 1.0's three years, effective for plan years beginning in **2025**, and extended it to **ERISA-covered 403(b)** plans. That obligation reaches **elective deferrals only**: the employer may, but need not, extend matching or nonelective contributions to these employees. IRS **coverage and nondiscrimination** testing separately stops plans favoring **highly compensated employees**, the reason **safe harbor 401(k)** designs exist.
