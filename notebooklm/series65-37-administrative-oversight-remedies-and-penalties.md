# Administrative Oversight, Remedies, and Penalties
...
## Who the Administrator is and what the office can do
...
- Felony — 1956 act §204(a)(2)(B): within the past 10 years. 2002 act §412(d)(3): any felony, no time limit.
- Qualifying misdemeanor — 1956 act §204(a)(2)(B): within the past 10 years. 2002 act §412(d)(3): within the previous 10 years.
...
- Outcome: Denial. Applies when: Applied for but not granted. Key feature: Prospective — no registration ever existed.
- Outcome: Suspension. Applies when: Existing registration. Key feature: Temporary; must have a definite end date.
- Outcome: Revocation. Applies when: Existing registration. Key feature: Permanent termination of the registration.
- Outcome: Cancellation. Applies when: Registrant has died, become mentally incompetent, ceased to exist, or cannot be located. Key feature: Not punitive and not disciplinary — it is a housekeeping action, so no hearing is required.
- Outcome: Withdrawal. Applies when: Registrant voluntarily files to withdraw. Key feature: Effective 30 days after filing if no proceeding is pending; the Administrator retains jurisdiction for 1 year to revoke or suspend.
...
**Which of the following powers does the state securities Administrator NOT possess under the Uniform Securities Act?**

The Administrator is an administrative and civil authority: it may investigate, subpoena, issue orders, and seek injunctive relief in court. Only a court may impose imprisonment, following a criminal prosecution brought by the appropriate prosecuting authority.

**Which of the following would provide grounds for the Administrator to deny, suspend, or revoke a registration?
